...
class SparkPositionMergeOnReadOperation implements RowLevelOperation, SupportsDelta {
  ...
  SparkPositionMergeOnReadOperation(SparkSession spark, Table table, RowLevelOperationInfo info,
    ...
    if (lazyScanBuilder == null) {
      this.lazyScanBuilder = new SparkScanBuilder(spark, table, options) {
        ...
        public Scan build() {
          ...
          SparkPositionMergeOnReadOperation.this.configuredScan = scan;
          return scan;
        }
      };
    }
