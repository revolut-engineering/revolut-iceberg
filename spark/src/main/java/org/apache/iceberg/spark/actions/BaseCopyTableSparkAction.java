...
public class BaseCopyTableSparkAction
  ...
  private final Set<String> metadataFilesToMove = Collections.synchronizedSet(new HashSet<>());
  private final Set<String> manifestFilePaths = Collections.synchronizedSet(new HashSet<>());
  private final Set<ManifestFile> manifestFilesToRewrite = Collections.synchronizedSet(new HashSet<>());
